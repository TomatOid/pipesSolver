...
It requires the curl library to be installed for scraping the puzzle site. You can build with `make` You can run the make command and it will output `run_solver` and `generate`.
